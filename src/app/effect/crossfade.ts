import { ImmediateRenderObject, LinearFilter, Mesh, MeshBasicMaterial, Object3D, OrthographicCamera, PerspectiveCamera, PlaneGeometry, RGBFormat, Scene, ShaderMaterial, Vector2, Vector3, WebGLRenderer, WebGLRenderTarget } from "three"
...
class Transition{
    ...
    moveTo(pano: Pano, hp: Hotspot,time=1500) {
        currPano = pano
        moveTarget = pano.pos.clone()
